...
def MakePlayerMove(Board, Ships):
  ...
  print("\nMoves: {0} | Hits: {1} | Misses: {2}".format(Moves, Hits, Misses))
  print("Percentage of hits: {0:.2f}".format(Hits/Moves*100))
...
def LoadGame(Filename, Board):
  ...
  while not FileOpened:
    try:
      ...
      Filename = str(input("Please choose another filename: "))
