...
def ValidateBoatPosition(Board, Ship, Row, Column, Orientation):
  if Orientation == "v" and Row + Ship[1] > 10: #If the orientation of the boat is v and the row number + the length of the ship is more than 10
    return False #return False
  elif Orientation == "h" and Column + Ship[1] > 10: #If the orientation of the boat is h and the column number + the length of the ship is more than 10
    return False #return False
  else:
    if Orientation == "v": #If the orientation of the boat is v then
      for Scan in range(Ship[1]): #Loop around this code for the length of the ship
        if Board[Row + Scan][Column] != "-": #If the selected square isn't - then
          return False #return False
    elif Orientation == "h": #
      for Scan in range(Ship[1]):
